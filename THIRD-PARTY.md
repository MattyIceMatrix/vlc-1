...
| producer | level | what it has | what stops it |
|---|---|---|---|
...
| this project's kernel journal (live capture) | **L5** | | — |
...
These are scores of **formats**, from **public documentation**, on **synthetic
samples**. A deployment can do better than its format allows — sequence numbers
